...
├── soul/
│   ├── __init__.py
│   └── _soul_driver.py      # v1.0.0
├── identity/
│   ├── __init__.py
│   └── _identity_router.py  # v1.0.0
├── memory/
│   ├── __init__.py
│   ├── _dynamic_cells.py    # v1.0.0
│   └── _learning_engine.py  # v1.0.0
├── context/
│   ├── __init__.py
│   ├── _claw_context.py     # v1.0.0
│   └── _claw_environment.py   # v1.0.0
├── _claw_engine.py          # v1.0.0
├── configs/
│   └── 孔子_v3.yaml
└── file/系统文件/
    └── Claw双阶段架构设计.md
