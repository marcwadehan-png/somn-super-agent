...
class DualModelService:
    ...
    def chat(
        ...
        """
        对话接口 - 与 LLMService.chat() 完全兼容 [v1.0]
        ...
        Args:
            prefer_local: [v1.0.0] 是否优先使用本地引擎（默认True）
            messages: [v1.0] 消息列表，支持图片等多模态内容
            use_capability_dispatch: [v1.0] 是否启用能力感知调度（默认False）
...
"""
    ...
    def _dispatch_local(
        ...
        **kwargs
        ...
        # [v1.0] 选择引擎 - LEFT=B脑(主脑), RIGHT=A脑(副脑)
