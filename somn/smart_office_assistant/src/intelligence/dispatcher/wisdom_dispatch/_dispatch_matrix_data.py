...
def get_matrix_data() -> Dict:
    ...
    return {
        ...
        # ── V1.0 第二阶段: 心理学ProblemType（礼部+厂卫联合） ──
        ...
        # ── V1.0 第二阶段: 系统论ProblemType（五军都督府+工部） ──
        PT.COMPLEX_SYSTEM: [
            (D.WUJUN, DR.PRIMARY,
        ...
        # ── V1.0 第二阶段: 管理学ProblemType（吏部+户部联合） ──
        ...
        # ── V1.0 第二阶段: 纵横家ProblemType（兵部+户部联合） ──
        ...
        # ── V1.0 精细优化: 学派子领域细分ProblemType部门路由 ──
