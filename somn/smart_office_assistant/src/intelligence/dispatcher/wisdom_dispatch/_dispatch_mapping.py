...
[v1.0.0 道家升级] 新增无为调度模式（WuWeiDispatchMode），
...
class WisdomDispatcher:
    ...
    # [v1.0 调度优化] pickle缓存版本号，修改后自动失效旧缓存
    ...
    def __init__(self):
        ...
        # [v1.0 映射索引优化] 构建反向索引：School → ProblemType（加速查询）
        ...
        # [v1.0 优化] 重新启用，已添加版本控制，支持V6.2+新问题类型
        ...
        self.school_weights = {
            ...
            # V1.0 第三阶段新增: 墨家/法家核心学派
            WisdomSchool.MOZI: 0.03,
            WisdomSchool.FAJIA: 0.04,
            # V1.0 第三阶段新增: 经济学/名家/阴阳家/复杂性科学
