...
[v1.0.0 道家升级] 新增道家否决权（DaoVeto）机制——
...
class MemberRole(Enum):
    ...
    SPECIALIST_A = "创新专员"
    WHITE_CLOTH = "白衣代表"
    # [v1.0.0 道家升级] 道家否决角色：可基于"过犹不及"原则行使否决权
    DAO_VETO = "道家否决代表"
...
class DecisionCongress:
    ...
    def submit_imperial_command(
        ...
        record = {
            ...
            "threshold": threshold,
            "submitted_at": time.time(),
            "hanlin_exempt": True,  # v1.0: 代表大会决策不受翰林院审核
            # [v1.0.0 道家升级] 否决权信息
            "dao_veto": {
