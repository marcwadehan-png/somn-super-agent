# -*- coding: utf-8 -*-
"""
Cloning系统 - 贤者克隆引擎 v1.0.0 (延迟加载优化版)
...
v1.0.0变更: EXTRA_SAGES改为延迟加载，避免导入时实例化858+SageMeta对象
...
from ._cloning_types import (
    ...
    DecisionOption,  # [v1.0.0] 补充导出
)
from ._cloning_base import SageCloning, SchoolCluster, Tier2ClusterCloning
from .tier1.confucius import ConfuciusCloning  # [v1.0.0] 补充导出
