# -*- coding: utf-8 -*-
"""
Somn 深度人设核心模块 v1.0.0 (v1.0.0)

v1.0.0 新增:简短回应引擎(BriefModeDecisionEngine)
- 日常沟通拒绝废话文学,简单明了传递观点
- 闲聊/吐槽/情绪共振场景支持人类化短回复
- "嗯嗯""好的""哈哈""牛逼"等口语化表达 + 表情包
- 怼人/温柔共情/治愈引导/专业方案 四大场景保持深度不受影响

v1.0.0 新增:智识型安慰/劝解系统(TenderModeDecisionEngine)
v1.0.0 新增:怼人decision引擎(SharpModeDecisionEngine)
