...
# [v1.0 优化] torch 不在模块顶层导入，延迟到 _ensure_networks() 内部
...
class ReinforcementLearningSystemV3:
    ...
    def __init__(self,
        ...
        # [v1.0 内存优化] priority_memory 改用 deque + heapq，避免每次 append 后全量 sort
