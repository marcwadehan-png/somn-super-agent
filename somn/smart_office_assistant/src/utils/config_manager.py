...
class LLMConfig:
    ...
    default_model: str = "gemma4-local-b"  # [v1.0] B模型(主脑)成为默认
    api_base: str = ""                       # [v1.0] 无需API地址，直接本地调用
    api_key: str = ""
    model_name: str = "gemma4-local-b"        # [v1.0] B模型Gemma4多模态为主
    fallback_model: str = "llama-3.2-1b-a"   # [v1.0] A模型Llama为副脑
