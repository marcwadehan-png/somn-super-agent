...
def test_module_export():
    ...
    try:
        ...
        print("✅ 所有导出项验证成功:")
        print("  [v1.0新增] NaturalLanguageDocumentService")
        print("  [v1.0新增] DocumentIntent")
        print("  [v1.0新增] DocumentFormat")
        print("  [v1.0新增] DocumentResult")
        print("  [v1.0新增] quick_process")
