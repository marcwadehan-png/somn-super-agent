...
V5.1: 补全SCHOOL_TO_DEPT映射（从43项→57项），覆盖全部70个未映射Claw。

版本: v5.1.0 | 2026-04-23
"""
...
# YAML六部 → 岗位体系专员岗部门路由（V5.1: 解决六部专员岗不足导致溢出到皇家的问题）
# V6.1更新: 六部已补充专员岗，优先路由到本部门
DEPT_FALLBACK_ROUTE = {
...
def match_claw(claw_name, claw_data, fill_count):
    ...
    # P3: 专员兜底（V5.1: 精确学派匹配 + 负载均衡 + 多部门路由）
...
report_text = '\n'.join(lines)
report_path = PROJECT_ROOT / "file" / "系统文件" / "Claw任职报告_V6.0.md"
